-- =====================================================================
-- FIX: Update check constraints to accept 0-4 instead of 1-4
-- =====================================================================
-- KOOS/WOMAC questionnaire uses 0-4 scoring (5 options)
-- 0 = None/Never/Best, 4 = Extreme/Always/Worst
-- This script updates all constraints to CHECK BETWEEN 0 AND 4
-- =====================================================================
...
-- Add new constraints for F1-F17 (0-4 range)
